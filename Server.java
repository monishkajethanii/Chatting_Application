...
public class Server implements MouseListener {
    ...
    public Server() {
        ...
        ImageIcon icon2 = new ImageIcon(
                "C:/Users/Monishka/OneDrive/Documents/Programs/AJP_Microproject/Chatting_Application/Chatting_Application/1.png");
        ...
        ImageIcon icon5 = new ImageIcon("C:/Users/Monishka/OneDrive/Documents/Programs/AJP_Microproject/Chatting_Application/Chatting_Application/3dot.jpeg");
    ...
    public static void main(String[] args) {
        try (ServerSocket skt = new ServerSocket(6001)) {
            new Server(); // Move GUI initialization outside the loop
            ...
            while (true) {
                ...
                // Close the resources for the current client
                // din.close();
                // dout.close();
                // s.close();
            }
